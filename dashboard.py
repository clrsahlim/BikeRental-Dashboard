...
st.subheader("Casual vs Registered Users per Day")
...
st.subheader("Bike Rental Trends per Hour on Working Day/Holiday")

fig, ax = plt.subplots(figsize=(12, 5))
ax.plot(workday_hour_df["hr"], workday_hour_df["cnt"], marker='o', linewidth=2, color="#8F3454")
ax.set_title("Working Days", loc="center", fontsize=20)
...
fig, ax = plt.subplots(figsize=(12, 5))
ax.plot(holiday_hour_df["hr"], holiday_hour_df["cnt"], marker='o', linewidth=2, color="#8F3454")
ax.set_title("Weekend/Holiday", loc="center", fontsize=20)
ax.set_xticks(range(0, 24))
ax.tick_params(axis='x', labelsize=14)
ax.tick_params(axis='y', labelsize=13)
ax.set_ylim(0, 550)
